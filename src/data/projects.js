const projects = [
  ...
  { id:7,
    ...
    description: "The matrimonial application offers user profile creation, search filters, and match recommendations. It enhances user experience with detailed profiles and intuitive navigation to find compatible matches",
    image: '/screenshot/matrimony.jpeg',
    url: "https://www.extwebtech.com/portfolio/",
    tags: ["React JS","TypeScript","MUI" ],
  },
  { id:8,
    title: 'Anovip Search Engine',
    description: "novipRDTool is an advanced search engine tool designed to function like Google, allowing users to search, discover, and retrieve information quickly",
